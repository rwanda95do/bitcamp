...
<c:if test="${sessionScope.memId != null }">
	...
	<c:if test="${sessionScope.memId == 'admin' }">
		<li><a href="${pageContext.request.contextPath }/imageboard/imageboardWriteForm.do">이미지등록</a></li>
	</c:if>
</c:if>
	<li><a href="${pageContext.request.contextPath }/board/boardList.do?pg=1">목록</a></li>
	<li><a href="${pageContext.request.contextPath }/imageboard/imageboardList.do">이미지목록</a></li>
</ul>