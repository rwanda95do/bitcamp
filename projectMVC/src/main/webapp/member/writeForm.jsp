...
<body>
<form id="writeForm" name="memberWriteForm" method="post">
	<img alt="home" src="../image/1.jpg" onclick="location.href='${pageContext.request.contextPath }/index.do'" style="cursor: pointer;">
	<h1>회원가입</h1>
