...
<form id="updateForm" name="updateForm">
	<table border="1" cellspacing="0" cellpadding ="5">
		<tr>
			...
			<td>
				<input type="text" id="name" class="name" name="name" value="<%=memberDTO.getName()%>">
				<div id="nameDiv"></div>
			</td>
		</tr>
		<tr>
			<th>아이디</th>
			<td>
				<input type="text" id="id" class="id" name="id" value="<%=memberDTO.getId()%>" size="30" readonly="readonly">
			</td>
		</tr>
	<tr>
			<th>비밀번호</th>
		...
		<tr>
			...
			<td>
				...
				-
				<input type="text" id="tel2" class="tel" name="tel2" maxlength="4" size="3" value="<%=memberDTO.getTel2() %>"> -
				<input type="text" id="tel3" class="tel" name="tel3" maxlength="4" size="3" value="<%=memberDTO.getTel3() %>">
			</td>
		</tr>
		<tr>
			<th>주소</th>
			<td>
				<input type="text" id="zipcode" name="zipcode" placeholder="우편번호입력" size="10" value="<%=memberDTO.getZipcode() %>">
				<button type="button" onclick="checkPost()">우편번호 검색</button>
				<input type="text" id="addr1"  name="addr1" placeholder="주소" size="60" readonly="readonly" value="<%=memberDTO.getAddr1() %>"><br>
				<input type="text" id="addr2"  name="addr2" placeholder="상세주소" size="60" value="<%=memberDTO.getAddr2() %>">
			</td>
		</tr>		
		<tr>
